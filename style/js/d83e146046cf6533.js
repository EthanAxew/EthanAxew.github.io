...
(function(e, t) {
	...
	var e = Array,
		...
		b = Math.min,
		w = r.toString,
		E = typeof Symbol == "function" && typeof Symbol.toStringTag == "symbol",
		S, x = Function.prototype.toString,
		T = /^\s*class /,
		N = function(t) {
			try {
				var n = x.call(t),
	...
	var D, P = String.prototype.valueOf,
		H = function(t) {
			try {
				return P.call(t), !0
			} catch(n) {
	...
	var z = m.bind(r.hasOwnProperty),
		...
		K = m.bind(u.indexOf),
		Q = m.bind(h),
		G = m.bind(r.propertyIsEnumerable),
		Y = m.bind(t.sort),
		Z = e.isArray || function(t) {
	...
	F(t, {
		forEach: function(t) {
			var n = R.ToObject(this),
				r = nt && D(this) ? J(this, "") : n,
				i = -1,
				s = R.ToUint32(r.length),
				o;
		...
		map: function(n) {
			var r = R.ToObject(this),
				i = nt && D(this) ? J(this, "") : r,
				s = R.ToUint32(i.length),
				o = e(s),
				u;
		...
		every: function(t) {
			...
			for(var o = 0; o < i; o++)
				if(o in r && (typeof s == "undefined" ? !t(r[o], o, n) : !t.call(s, r[o], o, n))) return !1;
			return !0
		}
	}, !rt(t.every)), F(t, {
		some: function(t) {
			...
			for(var o = 0; o < i; o++)
				if(o in r && (typeof s == "undefined" ? t(r[o], o, n) : t.call(s, r[o], o, n))) return !0;
			return !1
		}
	}, !rt(t.some));
	var it = !1;
	...
	F(t, {
		indexOf: function(t) {
			var n = nt && D(this) ? J(this, "") : R.ToObject(this),
				r = R.ToUint32(n.length);
			if(r === 0) return -1;
			var i = 0;
	...
	var mt = function(t) {
		...
		gt = function() {
			var e = {},
				t = Array.prototype.push.call(e, undefined);
	...
	var St = !{
		...
		xt = function() {}.propertyIsEnumerable("prototype"),
		Tt = !z("x", "0"),
		Nt = function(e) {
			var t = e.constructor;
	...
	F(n, {
		keys: function(t) {
			...
			var u = [],
				a = xt && n;
			if(s && Tt || r)
				for(var f = 0; f < t.length; ++f) Q(u, o(f));
			if(!r)
				for(var l in t)(!a || l !== "prototype") && z(t, l) && Q(u, o(l));
			if(St) {
				var c = Lt(t);
				for(var h = 0; h < Ot; h++) {
					var p = At[h];
	...
	var jt = (new Date(-0xc782b5b342b24)).getUTCMonth() !== 0,
		...
		It = new Date(14496624e5),
		qt = Ft.toUTCString() !== "Mon, 01 Jan -45875 11:59:59 GMT",
		Rt, Ut, zt = Ft.getTimezoneOffset();
	...
	var Wt = m.bind(Date.prototype.getFullYear),
		Xt = m.bind(Date.prototype.getMonth),
		Vt = m.bind(Date.prototype.getDate),
		$t = m.bind(Date.prototype.getUTCFullYear),
		Jt = m.bind(Date.prototype.getUTCMonth),
		Kt = m.bind(Date.prototype.getUTCDate),
		Qt = m.bind(Date.prototype.getUTCDay),
		Gt = m.bind(Date.prototype.getUTCHours),
		Yt = m.bind(Date.prototype.getUTCMinutes),
		Zt = m.bind(Date.prototype.getUTCSeconds),
		en = m.bind(Date.prototype.getUTCMilliseconds),
		tn = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
		nn = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
		rn = function(t, n) {
	...
	if(jt || Ut) Date.prototype.toString = function jn() {
		...
		throw new TypeError("this is not a Date object.")
	}, j && n.defineProperty(Date.prototype, "toString", {
		configurable: !0,
		enumerable: !1,
		writable: !0
	});
	var sn = -621987552e5,
		on = "-000001",
		un = Date.prototype.toISOString && (new Date(sn)).toISOString().indexOf(on) === -1,
		an = Date.prototype.toISOString && (new Date(-1)).toISOString() !== "1969-12-31T23:59:59.999Z",
		fn = m.bind(Date.prototype.getTime);
	F(Date.prototype, {
	...
	var cn = Date.parse("+033658-09-27T01:46:40.000Z") === 1e15,
		hn = !isNaN(Date.parse("2012-04-04T24:00:00.500Z")) || !isNaN(Date.parse("2012-11-31T23:59:59.000Z")) || !isNaN(Date.parse("2012-12-31T23:59:60.000Z")),
		pn = isNaN(Date.parse("2000-01-01T00:00:00.000Z"));
	if(pn || hn || !cn) {
		var dn = Math.pow(2, 31) - 1,
			vn = q((new Date(1970, 0, 1, 0, 0, 0, dn + 1)).getTime());
		Date = function(e) {
	...
	var mn = f.toFixed && (8e-5.toFixed(3) !== "http://www.mcllxz.cc/style/js/0.000" || .9.toFixed(0) !== "1" || 1.255.toFixed(2) !== "http://www.mcllxz.cc/style/js/1.25" || 0xde0b6b3a7640080.toFixed(0) !== "1000000000000000128"),
		gn = {
			base: 1e7,
			size: 6,
			data: [0, 0, 0, 0, 0, 0],
	...
	F(f, {
		...
		u.split = function(n, r) {
			...
			var s = [],
				o = (n.ignoreCase ? "i" : "") + (n.multiline ? "m" : "") + (n.unicode ? "u" : "") + (n.sticky ? "y" : ""),
				u = 0,
				a, f, l, c, p = new RegExp(n.source, o + "g");
	...
	var Mn = m.bind(String.prototype.trim),
		_n = u.lastIndexOf && "abc\u3042\u3044".lastIndexOf("\u3042\u3044", 2) !== -1;
	F(u, {
		lastIndexOf: function(t) {
			if(typeof this == "undefined" || this === null) throw new TypeError("can't convert " + this + " to object");
			var n = o(this),
				r = o(t),
				i = arguments.length > 1 ? a(arguments[1]) : NaN,
				s = q(i) ? Infinity : R.ToInteger(i),
				u = b(y(s, 0), n.length),
				f = r.length,
				l = u + f;
			while(l > 0) {
